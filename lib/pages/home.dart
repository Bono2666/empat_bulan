...
class _HomeState extends State<Home> {
  late List dbHome, dbTimeline, dbProfile, dbArticle, dbNotifications, dbQuestions, dbReply, dbChildBook;
  bool firstLoad = true;
  int currentAge = 0;
  String basecount = '';
  ...
  Future getHomeImage() async {
    var url = Uri.parse('https://app.empatbulan.com/api/get_home_image.php');
  ...
  Future getArticles() async {
    var url = Uri.parse('https://app.empatbulan.com/api/get_home_article.php');
    var response = await http.get(url);
    return json.decode(response.body);
  }
  ...
  Future getQuestions() async {
    var url = Uri.parse('https://app.empatbulan.com/api/get_all_questions.php');
    var response = await http.get(url);
    return json.decode(response.body);
  }
                                                                            ...
                                                                            child: InkWell(
                                                                              ...
                                                                              child: Container(
                                                                                ...
                                                                                child: Column(
                                                                                  ...
                                                                                  children: [
                                                                                    dbQuestions[index]['photo'] == '' ? Container() : SizedBox(
                                                                                      height: 43.0.w,
                                                                                      width: 86.6.w,
                                                                                      child: ClipRRect(
                                                                                        borderRadius: const BorderRadius.only(
                                                                                        ...
                                                                                        child: Container(
                                                                                          ...
                                                                                          child: Stack(
                                                                                            ...
                                                                                            children: [
                                                                                              ...
                                                                                              dbQuestions[index]['sensitif'] == '0' ? Container() : const Blur(),
                                                                                            ],
                                                                                          ),
                                                                                        ),
                                                                                      ),
                                                                  ...
                                                                  onTap: () {
                                                                    ...
                                                                    if (!prefs.getIsSignIn) {
                                                                      ...
                                                                      if (dbChildBook.isEmpty) {
                                                                        ...
                                                                        Navigator.pushNamed(context, '/childChart');
                                                                      }
                                                                    }
                                                                  },
                                                                  child: SizedBox(
