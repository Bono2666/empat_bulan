...
class _CartState extends State<Cart> {
  late List dbCart, dbGroupCart, dbExpCart, dbPrivateCart, dbUserCart, dbOtherCart, dbProfile;
  ...
  Future getExpCart() async {
    var url = Uri.parse('https://app.empatbulan.com/api/get_exp_cart.php?phone=${prefs.getPhone}');
    var response = await http.get(url);
    return json.decode(response.body);
  }

  Future getPrivateCart() async {
    var url = Uri.parse('https://app.empatbulan.com/api/get_private_cart.php?phone=${prefs.getPhone}');
    var response = await http.get(url);
    return json.decode(response.body);
  }
          ...
          builder: (context, snapshot) {
            ...
            return FutureBuilder(
              ...
              builder: (context, snapshot) {
                ...
                if (snapshot.connectionState == ConnectionState.done) {
                  dbExpCart = snapshot.data as List;
                  expCart = dbExpCart.isEmpty ? 0 : int.parse(dbExpCart[0]['item']);
                }
                return FutureBuilder(
                  future: getPrivateCart(),
                  builder: (context, snapshot) {
                    if (!snapshot.hasData || snapshot.data == null || snapshot.hasError) {
                      return
                        Column(
                    ...
                    if (snapshot.connectionState == ConnectionState.done) {
                      dbPrivateCart = snapshot.data as List;
                    }
                    return FutureBuilder(
                      future: getCart(),
                      builder: (context, snapshot) {
                                                ...
                                                dbCart.isNotEmpty
                                                  ...
                                                  child: ListView.builder(
                                                    ...
                                                    itemBuilder: (context, index) {
                                                      if (!dbCart[index]['type'].toString().contains('Private')) {
                                                        classDate = DateTime(
                                                            int.parse(dbCart[index]['date'].substring(0, 4)),
                                                            int.parse(dbCart[index]['date'].substring(5, 7)),
                                                            int.parse(dbCart[index]['date'].substring(8, 10))
                                                        );
                                                        if (classDate.compareTo(DateTime.now()) <= 0) {
                                                          updSelectedClass(int.parse(dbCart[index]['id']), 0);
                                                        }
                                                      }
                                                      return Dismissible(
                                                              ...
                                                              Row(
                                                                ...
                                                                children: [
                                                                  InkWell(
                                                                    onTap: () {
                                                                      if (dbCart[index]['type'].toString().contains('Private')
                                                                          || (!dbCart[index]['type'].toString().contains('Private') && classDate.compareTo(DateTime.now()) > 0)) {
                                                                        int selected;
                                        ...
                                        Stack(
                                            ...
                                            children: [
                                                          ...
                                                          InkWell(
                                                            onTap: () {
                                                              ...
                                                              if (dbGroupCart.isNotEmpty) {
                                                                if (int.parse(dbGroupCart[0]['selected_item']) == dbCart.length - expCart) {
                                                                  selectedAll = 0;
                                                                } else {
                                                                  selectedAll = 1;
                                                                }
                                                            ...
                                                            child: Image.asset(
                                                              dbGroupCart.isNotEmpty
                                                                  ? int.parse(dbGroupCart[0]['selected_item']) == dbCart.length - expCart
                                              ...
                                              InkWell(
                                                onTap: () async {
                                                  if (dbGroupCart.isNotEmpty) {
                                                    if (dbGroupCart[0]['selected_item'] == '1') {
                                                      if (dbPrivateCart.isEmpty) {
                                                        ...
                                                        Navigator.pushNamed(context, '/timeSchedule');
                                                      }
                                                    } else {
                                                      ScaffoldMessenger.of(context).showSnackBar(
                                                        SnackBar(
                                                          content: const Text(
                                                            'Pilih 1 Layanan saja dalam satu order.',
                                                            style: TextStyle(
