...
class _HomeServicesState extends State<HomeServices> {
  late List dbHome, dbClass, dbNotifications, dbCart, dbPrivate;
  bool firstLoad = true;
  int currentAge = 0;
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: InkWell(
                                                      onTap: () {
                                                        ...
                                                        Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => const Search(type: 'layanan',),));
                                                      },
                                                      child: Container(
                                                        height: 11.7.w,
                                                        decoration: BoxDecoration(
                            ...
                            Padding(
                              ...
                              child: InkWell(
                                onTap: () async {
                                  ...
                                  Navigator.pop(context);
                                  Navigator.pushReplacement(context, PageRouteBuilder(pageBuilder: (context, animation, secondaryAnimation) => const HomeServices(),
